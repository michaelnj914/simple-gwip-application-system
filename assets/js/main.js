...
let photo = null; //variable to hold the selected photo
...
myform.addEventListener("submit", async function (e) {
  e.preventDefault(); // stop normal form submission. Wanna use JavaScript instead

  let firstName = $("input[name='firstName']").val();
  let lastName = $("input[name='lastName']").val();
  const name = firstName.toUpperCase() + " " + lastName.toUpperCase(); //will use this later for success message
